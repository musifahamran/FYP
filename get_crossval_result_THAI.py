...
def main(args):
    ...
    sessions      = ['studio1-10','studio11-20','studio21-30','studio31-40','studio41-50','studio51-60','studio61-70','studio71-80']
    five_fold_idx = [0,3,5,7,9,11,13,15] #index of speaker ID used as test_id for 5 fold CV -> [1M, 2F, 3M, 4F, 5F]
    ...
    for ns in range(n_runs):
        f = f'allstat_THAI_{label}_{ns}.pkl'
        try:
